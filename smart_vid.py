...
def main(argv):
    ...
    print('Analysing waveform of "{}"'.format(music_file_path))
    ...
    for idx in range(int(complexity)):
        make_sub_movie(music_file_path, float(bpm), videos_list, idx, start, finish, duration, intensities, resolution)
